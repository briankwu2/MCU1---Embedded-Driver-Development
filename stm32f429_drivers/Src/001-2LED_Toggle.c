...
/*
    ...
    2 - LED Toggling with OPEN-DRAIN Configuration 
*/
...
#define ENABLE_COMPILATION 0     // Change to 1 and other "main" files to compile this one
    ...
    int main(void) 
    {
        ...
        gpio_led_green.GPIO_PinConfig.GPIO_PinOPType = GPIO_OP_TYPE_OD; // Open-Drain configuration
        gpio_led_green.GPIO_PinConfig.GPIO_PinPuPdControl = GPIO_PIN_PU; // Activates Pull-Up Resistor
        ...
        gpio_led_orange.GPIO_PinConfig.GPIO_PinOPType = GPIO_OP_TYPE_OD; // Open-Drain Configuration
        gpio_led_orange.GPIO_PinConfig.GPIO_PinPuPdControl = GPIO_PIN_PU; // Activates Pull-Up Resistor
